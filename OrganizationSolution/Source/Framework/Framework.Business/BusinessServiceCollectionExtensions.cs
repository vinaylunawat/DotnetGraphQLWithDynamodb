namespace Framework.Business
{
    ...
    public static class BusinessServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddAutoMappers(this IServiceCollection services, IEnumerable<Assembly> assemblies)
        {
        ...
        /// <returns>The <see cref="IServiceCollection"/>.</returns>
        public static IServiceCollection AddAutoMappers(this IServiceCollection services, Assembly assembly)
        {
            EnsureArg.IsNotNull(services, nameof(services));
            EnsureArg.IsNotNull(assembly, nameof(assembly));

            return AddAutoMappers(services, new[] { assembly });
        }
